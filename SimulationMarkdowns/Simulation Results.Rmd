...
t.test(AllData$Shift_Env   ,  mu = 0, alternative = "two.sided" )
t.test(AllData$Shift_Spa   ,  mu = 0, alternative = "two.sided" )
t.test(AllData$Shift_CoDist,  mu = 0, alternative = "two.sided" )
t.test(AllData$Shift_r2    ,  mu = 0, alternative = "two.sided" )
