...
Fit_VP10(RunID,TrialName,InputParameters,niter = 20000, nburn = 10000,
         thin = 10,OccuMin = 5 , FalseAbsence = InputParameters$FalseAbsenceFrac[RunID])  # full 
 # Fit_VP10(RunID,TrialName,InputParameters,niter = 100, nburn = 50, thin = 1,
 #       OccuMin = 5 , FalseAbsence = InputParameters$FalseAbsenceFrac[RunID]) # quick for testing
